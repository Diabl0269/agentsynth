...
- [`docs/mixer.md`](docs/mixer.md) — Mixer channels (P9-1, PROPOSED): the ChannelStrip node is the channel, macros are the container, solo as a render-time gate, Master/Direct, channel templates
