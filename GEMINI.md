...
- FX Modules: Delay, Distortion, Reverb, Chorus, Phaser, Compressor, Flanger, Limiter, Parametric EQ
...
- `Source/Modules/FX/ParametricEQModule.h`: Four-band parametric EQ (low shelf, 2 bells, high shelf) with in-house RBJ biquads and analytic magnitude helpers for the visualiser
