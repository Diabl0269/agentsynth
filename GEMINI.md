...
- `Source/UI/FrequencyGrid.h`: Log-frequency / dB axis maths shared by both frequency-domain visualisers
- `Source/UI/EQCurveComponent.h`: Parametric EQ response curve (±30 dB window, per-band handles, optional FFT overlay)
