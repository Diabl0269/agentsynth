...
/**
 * @brief Channel shape of an audio/CV Macro port (docs/macros_ports.md §5.3, P8-15 Macro I/O).
 *
 ...
 *
 * `Stereo` vs `StereoCollapsed` (founder-review fix G2, docs/macros_ports.md §5.3 / docs/macros_implementation.md §7
 ...
 *  already behave as (docs/macros_ports.md §5.3's implementation note: "today the only value anything
 *  ever sets is Mono"). */
