...
juce::AudioProcessorGraph::Node* ensureMasterNode(juce::AudioProcessorGraph& graph, AppUndoManager& undoManager,
    ...
    undoManager.recordCombinedChange(graph, doc, [&] {
        // Through the factory, so the node round-trips through graphToJSON / applyJSONToGraph —
        // which is how undo, redo and save reproduce it.
