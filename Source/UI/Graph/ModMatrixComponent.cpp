...
// pin that). Founder-review fix G3 (docs/macros/auto-ports.md#a-modulation-cable-through-an-attenuverter) can still splice a MacroInletModule
...
// always Mono with its one active raw channel at 0 (docs/macros/ports.md#a-port-shape-is-chosen-at-creation-and-then-fixed / docs/macros/auto-ports.md#a-modulation-cable-through-an-attenuverter
