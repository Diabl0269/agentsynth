...
std::vector<GraphEditor::VisibleCable> GraphEditor::rebuildVisibleCables() {
    ...
    // re-anchored on the card. Two anchor treatments, per docs/macros/ports.md#cable-rendering-across-the-boundary's
    // table:
    ...
    //     same edge. That case doesn't disappear (docs/macros/ports.md#cable-rendering-across-the-boundary) and must
