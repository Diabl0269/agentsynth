...
#include "UI/Chrome/ColourPickerPopup.h" // juce::PropertiesFile (juce_data_structures) + ColourPickerPopup itself (T152)
#include <functional>
...
/**
 * @brief "Create ports for the crossing cables?" modal (founder-review fix F5, docs/macros/auto-ports.md#ungroup-and-direct-deletion-of-a-port
