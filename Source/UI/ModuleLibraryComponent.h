...
public:
    ...
    ModuleLibraryComponent() {
        ...
        // Prevent the parent component from grabbing focus when clicked (e.g. on the
        // collapse-all strip), which would cause the searchEditor child to gain focus
        // even when the click isn't on it.
