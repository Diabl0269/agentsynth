...
TEST(ModuleLibraryDescriptionFor, KnownModulesReturnNonEmpty) {
    const char* known[] = {"Oscillator",   "Noise",     "Sampler",       "LFO",        "Sequencer",    "Poly Sequencer",
                           "MidiKeyboard", "Poly MIDI", "External MIDI", "ADSR",       "VCA",          "Filter",
                           "Chorus",       "Phaser",    "Flanger",       "Distortion", "Delay",        "Reverb",
                           "Compressor",   "Limiter",   "Voice Mixer",   "Bitcrusher", "Pitch Shifter"};
