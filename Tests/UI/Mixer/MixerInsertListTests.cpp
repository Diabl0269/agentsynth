...
//   * moveRow  -- a bus's sourceNodeId_ is invalid (no external predecessor -- docs/mixer.md
//                 §5.15 D6), so moving a row to the very front of its chain must refuse rather than
