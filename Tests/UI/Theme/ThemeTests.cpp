...
#else
    // Fallback: <repo>/themes next to TESTS_ROOT_DIR (<repo>/Tests), independent of this file's depth.
    juce::File themesDir = juce::File(TESTS_ROOT_DIR).getSiblingFile("themes");
#endif
