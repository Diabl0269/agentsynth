...
public:
    ...
    void addInstrumentTrack(const juce::String&, bool) override { ++addInstrumentTrackCalls; }
...
// Tests/Modules/ModuleMidiFlagsTests.cpp for MainComponent's real enumeration, exercised end-to-end).
