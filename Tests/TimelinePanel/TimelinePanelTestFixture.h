...
//
// Shared fixtures for the TimelinePanel test suite (Tests/TimelinePanel/TimelinePanel*Tests.cpp).
...
// ============================================================================
// Hand-built MouseEvent helpers, same pattern as Tests/GraphEditor/GraphEditorViewportTests.cpp/
