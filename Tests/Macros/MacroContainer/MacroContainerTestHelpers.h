...
// Shared helpers for the MacroContainer test suite (Tests/Macros/MacroContainer/MacroContainer*Tests.cpp).
...
// into GraphEditor itself, the same way GraphEditorViewportTests.cpp (Tests/UI/Graph/GraphEditor/) and
