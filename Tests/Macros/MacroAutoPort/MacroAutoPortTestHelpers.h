...
// (Tests/UI/Graph/GraphEditor/) — no OS mouse source exists headlessly, but MouseInputSource is copyable
...
// Inverse of GraphEditorViewportTests.cpp's screenToCanvas (Tests/UI/Graph/GraphEditor/): a cable's p1/p2
