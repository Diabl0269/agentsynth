...
TEST_F(E2EWorkflowTest, DropAllModuleTypes_NoCrash) {
    const juce::StringArray moduleTypes = {"Oscillator", "Noise",        "Sampler",        "Filter",    "ADSR",
                                           "VCA",        "Sequencer",    "Poly Sequencer", "LFO",       "Distortion",
                                           "Delay",      "Reverb",       "MidiKeyboard",   "Chorus",    "Phaser",
                                           "Compressor", "Flanger",      "Limiter",        "Poly MIDI", "Voice Mixer",
                                           "Bitcrusher", "Pitch Shifter"};
