// Snapshot mechanics: graphToJSON/applyJSONToGraph round-trips, param handling, merge-mode node
// add/update/remove, modulation (de)serialization, and the preset-load logging guard.
