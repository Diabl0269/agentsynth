...
struct ModuleRig {
    ...
    ModuleRig() {
        ...
        // assertion here keeps meaning what it always meant. The gate itself is Tests/Engine/FeedbackGuardTests.cpp's
        // job.
...
TEST(AudioInputModuleTest, DeviceInputFlowsThroughModule) {
    ...
    // gate itself is Tests/Engine/FeedbackGuardTests.cpp's job.
