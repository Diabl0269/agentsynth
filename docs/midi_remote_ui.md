...
|---|---|---|---|
| 1 | **Model + persistence**: `Source/MidiRemote/` types, JSON round-trip, profile file store, `"midiRemote"` project key (stash/carry, refused untrusted, `MidiRemoteNotAllowed`), undo `recordMidiRemoteChange` | — | FRO124 — shipped (PR #TBD) |
