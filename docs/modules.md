...
`Source/Plugin/Hosting/HostedPluginModule.h` · `ModuleType::HostedPlugin` · factory key `"Hosted Plugin"` (TL7-2)
...
- **Not yet**: TL7-3 plugin scanning and the load UX (which is why the module is library-less today), TL7-5/6 plugin editor windows and parameter exposure, TL7-7 latency compensation.
