...
`Master` nodes and the solo gate ([`../mixer.md`](../mixer.md)). Headless. **Module-level** tests
...
it are in [`../testing_mixer_meters.md`](../testing_mixer_meters.md).
...
drag API. The "Make channel" cases ([`../mixer.md`](../mixer.md) §5.8) add a render-identity rig —
...
`Tests/Mixer/MixerModel/` — headless column-ordering logic ([`../mixer.md`](../mixer.md) §5.10),
