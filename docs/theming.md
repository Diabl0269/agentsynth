...
| `timelinePanelHeight` | `220` | Timeline panel **default** height and minimum drag height (px) — the live height is the user's, persisted under the `timelinePanelHeight` setting key (see [`timeline/timeline.md`](timeline/timeline.md#panel-height)) — code-only |
